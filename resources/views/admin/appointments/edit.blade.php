                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.appointments.update', $appointment->id) }}">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="first_name" name="first_name" class="block w-full mt-1" value="{{ $appointment->first_name }}" />
                            </div>
                        </div>
                        <!-- Last Name -->
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="last_name" name="last_name" class="block w-full mt-1" value="{{ $appointment->last_name }}"/>
                            </div>
                        </div>
                        <!-- Email -->
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="email" id="email" name="email" class="block w-full mt-1" value="{{ $appointment->email }}"/>
                            </div>
                        </div>
                        <!-- Phone Number -->
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="tel_number" name="tel_number" class="block w-full mt-1" value="{{ $appointment->tel_number }}"/>
                            </div>
                        </div>
                        <!-- Appointment Date -->
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="datetime-local" id="date" name="date" class="block w-full mt-1" value="{{ $appointment->date }}"/>
                            </div>
                        </div>
                        <!-- Service Selection -->
                            ...
                            <div class="mt-1">
                                <select id="stylist_id" name="stylist_id" class="form-multiselect block w-full mt-1">
                                    ...
                                    @foreach ($stylists as $stylist)
                                        <option value="{{ $stylist->id }}" @if($stylist->id == $appointment->stylist_id) selected @endif>
